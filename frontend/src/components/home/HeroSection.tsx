      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-3xl animate-fadeInUp">
            ...
            <div className="mb-8">
              <button onClick={() => setShowCountrySelector(true)} className="w-full md:w-auto flex items-center justify-between px-6 py-4 bg-indigo-900/50 border border-indigo-500/30 rounded-xl hover:bg-indigo-800/50 transition-colors text-white">
          ...
          <div className="relative animate-fadeInRight">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-[#2D2755] bg-[#1B1537]/20 backdrop-blur-sm">
              <div className="aspect-video w-full">
                <img src="/Branch_LP.jpg" alt="Platform dashboard" className="w-full h-full object-cover" />
              </div>
