      ...
      <section className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div>
              <div className="flex items-center mb-2">
                <PercentIcon className="h-6 w-6 text-[#EA3A70] mr-2" />
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mt-8">
            <Link to="/portal/tax-filing" className="px-6 py-3 bg-[#EA3A70] hover:bg-[#EA3A70]/90 text-white rounded-lg shadow-lg shadow-[#EA3A70]/20 font-medium flex items-center justify-center">
              Get Started
