...
import { ArrowLeftIcon, CheckCircleIcon, ChevronRightIcon, BuildingIcon, FileTextIcon, UsersIcon, CoinsIcon, ClipboardIcon, BookOpenIcon, CreditCardIcon, CalendarIcon } from 'lucide-react';
...
export function DutchBVSetupTutorial() {
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-[#1B1537] rounded-lg p-6 border border-[#2D2755]">
            <h3 className="text-xl font-bold text-white mb-4">Why Choose a BV?</h3>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <CheckCircleIcon className="h-5 w-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-white">International Flexibility</h4>
                    <p className="text-gray-300 text-sm">Suitable structure for cross-border operations and foreign investments</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <CheckCircleIcon className="h-5 w-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-white">Ownership Transferability</h4>
                    <p className="text-gray-300 text-sm">Shares can be sold or transferred with appropriate documentation</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#1B1537] rounded-lg p-6 border border-[#2D2755]">
            <h3 className="text-xl font-bold text-white mb-4">Consider Alternatives</h3>
            <p className="text-gray-300 mb-4">
              A BV requires more administration than a sole proprietorship (Eenmanszaak) or partnership (VOF). 
              If your business is small with minimal liability risks and you prefer simpler administration, 
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-[#1B1537] rounded-lg p-6 border border-[#2D2755]">
            <h3 className="text-xl font-bold text-white mb-4">Brand Considerations</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">Within 8 days after executing the deed of incorporation</p>
                </div>
              </div>
              <div className="flex items-start">
                <CheckCircleIcon className="h-5 w-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <Link 
              to="/tutorials"
              className="inline-flex items-center text-[#EA3A70] hover:text-[#EA3A70]/80 font-medium transition-colors mb-6"
            >
              ...
              <div className="bg-[#1B1537] rounded-xl border border-[#2D2755] p-8">
                <div className="flex items-center mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Step {activeStep} of {steps.length}</p>
                  </div>
                </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#1B1537] to-[#2A1F4F]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {nextSteps.map((step, index) => (
              <div key={index} className="flex items-start bg-[#0F0B1F]/50 rounded-lg p-4 border border-[#2D2755]">
                <CalendarIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="mt-12 bg-[#1B1537] rounded-xl border border-[#2D2755] p-8">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center px-6 py-3 bg-[#EA3A70] text-white rounded-lg hover:bg-[#EA3A70]/90 transition-colors font-medium"
            >
