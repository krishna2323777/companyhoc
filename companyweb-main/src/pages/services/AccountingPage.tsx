      ...
      <section className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div>
              <div className="flex items-center mb-2">
                <LineChartIcon className="h-6 w-6 text-[#EA3A70] mr-2" />
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 mt-8">
            <Link to="/portal/accounting" className="px-6 py-3 bg-[#EA3A70] hover:bg-[#EA3A70]/90 text-white rounded-lg shadow-lg shadow-[#EA3A70]/20 font-medium flex items-center justify-center">
              Get Started
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-[#1B1537]/80 backdrop-blur-sm rounded-xl border border-[#2D2755] p-6 mb-10">
            ...
            {activeDemo === 'tax-analysis' && <div className="relative">
                <img src="/Corporate_Tax_Analaysis.jpg" alt="Tax Analysis Interface" className="w-full rounded-xl border border-indigo-500/30" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="/accounting_documents.jpg" alt="Document Management Interface" className="rounded-xl border border-indigo-500/30 shadow-xl" />
