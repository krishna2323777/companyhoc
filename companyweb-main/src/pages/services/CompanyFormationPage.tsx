        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-indigo-900/20 rounded-xl overflow-hidden border border-indigo-500/30">
              ...
              <div className="border-t border-indigo-500/30 bg-indigo-900/30 p-4">
                <img src="/branch_registration_portal.jpg" alt="Company Formation Portal Interface" className="w-full rounded-lg shadow-lg" />
              </div>
            </div>
            <div className="bg-indigo-900/20 rounded-xl overflow-hidden border border-indigo-500/30">
              <div className="p-6">
              ...
              <div className="border-t border-indigo-500/30 bg-indigo-900/30 p-4">
                <img src="/company_formation_chatbot_demo.jpg" alt="AI Company Formation Agent" className="w-full rounded-lg shadow-lg" />
              </div>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-500/30">
              ...
              <img src="/branch_registration_upload_documents.jpg" alt="Document Management Interface" className="w-full rounded-lg shadow-lg" />
            </div>
            <div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-500/30">
              <div className="p-3 bg-indigo-900/50 rounded-lg inline-block mb-4">
