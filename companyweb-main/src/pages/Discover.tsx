    ...
    <div className="min-h-screen bg-[#0F0B1F]">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            <BookOpenIcon className="h-16 w-16 text-[#EA3A70] mx-auto mb-6" />
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-[#1B1537] border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#EA3A70] transition-colors"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 py-2 bg-[#1B1537] border border-gray-600 rounded-lg text-white focus:outline-none focus:border-[#EA3A70] transition-colors"
                >
                ...
                <article key={post.id} className="bg-[#1B1537] rounded-xl overflow-hidden border border-gray-700 hover:border-[#EA3A70] transition-all duration-300 hover:shadow-2xl hover:shadow-[#EA3A70]/20">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-[#EA3A70] text-white">
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      to={`/blog/${post.id}`}
                      className="inline-flex items-center text-[#EA3A70] hover:text-[#EA3A70]/80 font-medium transition-colors"
                    >
                      Read More
      ...
      {/* Newsletter Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-[#1B1537] to-[#2A1F4F]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 bg-[#0F0B1F] border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#EA3A70]"
            />
            <button className="px-6 py-3 bg-[#EA3A70] text-white rounded-lg hover:bg-[#EA3A70]/90 transition-colors font-medium">
              Subscribe
            </button>
          </div>
        </div>
